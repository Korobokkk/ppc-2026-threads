...
TEST_P(KiselevIRunFuncTestsThreads, MatmulFromPic) {
...
const auto kPerfTestName = KiselevIRunFuncTestsThreads::PrintFuncTestName<KiselevIRunFuncTestsThreads>;

INSTANTIATE_TEST_SUITE_P(PicMatrixTests, KiselevIRunFuncTestsThreads, kGtestValues, kPerfTestName);
